...
const tabs=[
    {
        ...
        icon:(active) => (
            <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
                ...
                stroke={active ? '#C9A84C':'#6B7280'}
                strokeWidth="1.8"
                fill={active ? '#C9A84C22' : 'none'}
                />
                 <path
                 d="M9 22V12h6v10"
                 stroke={active ? '#C9A84C' : '#6B7280'}
    ...
    },
    {
        ...
        />
        <path
          d="M17 11c1.66 0 3 1.34 3 3s-1.34 3-3 3"
          stroke={active ? '#C9A84C' : '#6B7280'}
          strokeWidth="1.8"
          strokeLinecap="round"
        />
        <path
          d="M20 21c0-2.21-1.34-4.1-3.27-4.76"
          stroke={active ? '#C9A84C' : '#6B7280'}
          strokeWidth="1.8"
          strokeLinecap="round"
        />
    ...
    },
    {
      ...
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        ...
        />
        <path
          d="M8 13h2M12 13h4M8 17h2M12 17h4"
          stroke={active ? '#C9A84C' : '#6B7280'}
          strokeWidth="1.5"
          strokeLinecap="round"
        />
